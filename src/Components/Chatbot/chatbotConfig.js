...
const flow = {
  start: {
    message: "Hello, I am Ollie 👋! Welcome to Sew Smooth...",
  ...
  process_options: {
    ...
    path: async (params) => {
      ...
      switch (params.userInput) {
        case "Home":
          link = "https://sew-smooth.com/";
          break;
        case "Shop":
          link = "https://sew-smooth.com/Shop";
          break;
        case "About Us":
          link = "https://sew-smooth.com/AboutUs";
          break;
        case "Login":
          link = "https://sew-smooth.com/login";
          break;
        case "Github":
          link = "https://sew-smooth.com/JVMull/sew-smooth";
          break;
        case "Ask AI":
  ...
  chatgpt_query: {
    message: async (params) => {
      try {
        ...
        let products = [];
        try {
          const response = await fetch('https://sew-smooth.com/api/products');
...
5. Keep discussions on the topic of skateboarding. You may give advice related to skateboarding tips and tricks`;
        ...
        const geminiResponse = await fetch(`https://sew-smooth.com/api/chat`, {
          method: "POST",
          headers: {
